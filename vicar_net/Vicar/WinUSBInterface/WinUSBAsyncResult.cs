...
{
  public class WinUSBAsyncResult : IAsyncResult, IDisposable
  {
    ...
    public WinUSBAsyncResult(AsyncCallback userCallback, object stateObject)
    {
    ...
    public void OnCompletion(bool completedSynchronously, Exception error,
      int bytesTransfered, bool synchronousCallback)
    {
      lock (this)
      {
